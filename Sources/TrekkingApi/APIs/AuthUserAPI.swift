...
open class AuthUserAPI {
     ...
     */
    @discardableResult
    open class func authUserFollowUser(userId: String, action: Bool, apiResponseQueue: DispatchQueue = TrekkingApiAPI.apiResponseQueue, completion: @escaping ((_ data: Bool?, _ error: Error?) -> Void)) -> RequestTask {
        return authUserFollowUserBuilder(userId: userId, action: action).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<AdventuresLightModel>
     */
    open class func authUserFollowUserBuilder(userId: String, action: Bool) -> RequestBuilder<Bool> {
        var localVariablePath = "/api/v2.0/AuthUser/FollowAction/{userId}"
        
        
        let idPreEscape = "\(APIHelper.mapValueToPathItem(userId))"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{userId}", with: idPostEscape, options: .literal, range: nil)
        let localVariableURLString = TrekkingApiAPI.basePath + localVariablePath
        let localVariableParameters: [String: Any]? = nil
     ...
     */
    @discardableResult
    open class func authUserBookmark(model: BookmarkModel, apiResponseQueue: DispatchQueue = TrekkingApiAPI.apiResponseQueue, completion: @escaping ((_ data: Bool?, _ error: Error?) -> Void)) -> RequestTask {
        return authUserBookmarkWithRequestBuilder(model: model).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<Bool>
     */
    open class func authUserBookmarkWithRequestBuilder(model: BookmarkModel) -> RequestBuilder<Bool> {
        let localVariablePath = "/api/v2.0/AuthUser/Bookmarks"
        let localVariableURLString = TrekkingApiAPI.basePath + localVariablePath
     ...
     */
    @discardableResult
    open class func authUserBookmarks(apiResponseQueue: DispatchQueue = TrekkingApiAPI.apiResponseQueue, completion: @escaping ((_ data: [BookmarkModel]?, _ error: Error?) -> Void)) -> RequestTask {
        return authUserBookmarksWithRequestBuilder().execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<Bool>
     */
    open class func authUserBookmarksWithRequestBuilder() -> RequestBuilder<[BookmarkModel]?> {
        let localVariablePath = "/api/v2.0/AuthUser/Bookmarks"
        let localVariableURLString = TrekkingApiAPI.basePath + localVariablePath
        let localVariableParameters: [String: Any]? = nil
        ...
        let localVariableRequestBuilder: RequestBuilder<[BookmarkModel]?>.Type = TrekkingApiAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func authUserDownloads(apiResponseQueue: DispatchQueue = TrekkingApiAPI.apiResponseQueue, completion: @escaping ((_ data: [String]?, _ error: Error?) -> Void)) -> RequestTask {
        return authUserDownloadsWithRequestBuilder().execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<Bool>
     */
    open class func authUserDownloadsWithRequestBuilder() -> RequestBuilder<[String]?> {
        let localVariablePath = "/api/v2.0/AuthUser/Downloads"
        let localVariableURLString = TrekkingApiAPI.basePath + localVariablePath
        let localVariableParameters: [String: Any]? = nil
     ...
     */
    @discardableResult
    open class func authUserDownload(id: String, apiResponseQueue: DispatchQueue = TrekkingApiAPI.apiResponseQueue, completion: @escaping ((_ data: Bool?, _ error: Error?) -> Void)) -> RequestTask {
        return authUserDownloadWithRequestBuilder(id: id).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<Bool>
     */
    open class func authUserDownloadWithRequestBuilder(id: String) -> RequestBuilder<Bool?> {
        
        
        var localVariablePath = "/api/v2.0/AuthUser/Downloads/{id}"
