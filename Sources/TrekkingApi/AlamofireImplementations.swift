...
open class AlamofireRequestBuilder<T>: RequestBuilder<T> {
    ...
    @discardableResult
    override open func execute(_ apiResponseQueue: DispatchQueue = TrekkingApiAPI.apiResponseQueue, _ completion: @escaping (_ result: Swift.Result<Response<T>, ErrorResponse>) -> Void) -> RequestTask {
            ...
            validatedRequest.response(queue: apiResponseQueue,
                ...
                do {
                    ...
                    if let headerFileName = self.getFileName(fromContentDisposition: dataResponse.response?.allHeaderFields["Content-Disposition"] as? String) {
                        ...
                        requestPath = requestPath.appending("/tmp.TrekkingApi.\(UUID().uuidString)")
                    }
