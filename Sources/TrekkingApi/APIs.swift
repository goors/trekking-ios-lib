...
// We reverted the change of TrekkingApiAPI to TrekkingApi introduced in https://github.com/OpenAPITools/openapi-generator/pull/9624
...
@available(*, deprecated, renamed: "TrekkingApiAPI")
...
open class RequestBuilder<T> {
    ...
    required public init(method: String, URLString: String, parameters: [String: Any]?, headers: [String: String] = [:], requiresAuthentication: Bool) {
        ...
        addHeaders(TrekkingApiAPI.customHeaders)
    }
    ...
    @discardableResult
    open func execute(_ apiResponseQueue: DispatchQueue = TrekkingApiAPI.apiResponseQueue, _ completion: @escaping (_ result: Swift.Result<Response<T>, ErrorResponse>) -> Void) -> RequestTask {
        return requestTask
    }
    ...
    open func addCredential() -> Self {
        credential = TrekkingApiAPI.credential
        return self
    }
}
