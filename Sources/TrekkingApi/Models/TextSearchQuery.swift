...
public final class TextSearchQuery: Codable, JSONEncodable, Hashable {
    ...
    public init(sort: String? = nil, page: Int? = nil, pageSize: Int? = nil, maxItemCount: Int? = nil, text: String? = nil) {
        self.sort = sort
        self.page = page
    ...
    public static func == (lhs: TextSearchQuery, rhs: TextSearchQuery) -> Bool {
        lhs.sort == rhs.sort &&
        lhs.page == rhs.page &&
