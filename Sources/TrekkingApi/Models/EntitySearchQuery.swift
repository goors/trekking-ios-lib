...
public final class EntitySearchQuery: Codable, JSONEncodable, Hashable {
    ...
    public static func == (lhs: EntitySearchQuery, rhs: EntitySearchQuery) -> Bool {
        lhs.sort == rhs.sort &&
        lhs.page == rhs.page &&
